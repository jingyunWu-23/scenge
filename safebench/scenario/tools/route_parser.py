...
class RouteParser(object):
    ...
    def parse_routes_file(route_filename, scenario_file, single_route=None):
        ...
        for route in tree.iter("route"):
            ...
            new_config.route_region = (
                route.attrib["region"] if "region" in route.attrib else None
            )
            ...
            for waypoint in route.iter("waypoint"):
                if len(waypoint_list) == 0:
                    ...
                    z = (
                        float(waypoint.attrib["z"]) + 2.0
                    )  # avoid collision to the ground
    ...
    def scan_route_for_scenarios(
        route_name, trajectory, world_annotations, scenario_id=None
    ):
        """
    ...
    @staticmethod
    def match_route_and_scenarios(
        town_name, trajectory, possible_scenarios, scenario_id=None
    ):
        select_scenarios = []
